...
library(rio)
library(ggplot2)
#use_condaenv("/Users/nataliebiderman/Software/anaconda3/envs/pythonenv", required = NULL)
...
curr_iti = rtruncexp(nrow(curr_df), 
                     ...
                     a=iti_params$min, 
                     b=iti_params$max)
curr_iti = round_any(as.numeric(curr_iti), 0.1)*1000 # convert iti to jumps of 500ms (so length will be divided by TR)
mean(curr_iti) # 2625
max(curr_iti) # 5000
min(curr_iti) # 1500
(sum(curr_iti) + nrow(curr_df)*stimulus_duration)/60000
hist(curr_iti)
